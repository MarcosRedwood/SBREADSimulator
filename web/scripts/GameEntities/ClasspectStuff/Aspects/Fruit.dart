...
class Fruit extends Aspect {
    ...
    Fruit(int id) :super(id, "Fruit", isCanon: true);
    ...
    void initializeThemes() {
        ...
        addTheme(new Theme(<String>["Lies", "Bullshit", "Deceit","Slander", "Fakes", "Con Artists", "Ruses"])
            ...
            ..addFeature(new DenizenQuestChain("Believe the Lies", [
                ...
                new Quest("The ${Quest.PLAYER1} is contemplating the magical ${Quest.PHYSICALMCGUFFIN} they wasted their boonies on.  Why would the Crafty ${Quest.CONSORT} tell such specific lies? Maybe...this is some kind of... challenge? The ${Quest.PLAYER1} spends time imagining what they would try to make if it were true."),
