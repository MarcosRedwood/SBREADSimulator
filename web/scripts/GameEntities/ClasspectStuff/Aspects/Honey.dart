...
class Honey extends Aspect {
    ...
    Honey(int id) :super(id, "Honey", isCanon: true);
    @override
    ...
    void initializeThemes() {
        ...
        addTheme(new Theme(<String>["Decisions","Choices", "Paths", "Passages", "Dead Ends","Trails", "Doors", "Possibilities", "Alternatives","Labrinths","Mazes"])
            ...
            ..addFeature(new DenizenQuestChain("Pick a Door, any Door", [
                new Quest("The ${Quest.PLAYER1} boggles vacantly at an entire labyrinth of doors. Whole walls are nothing but doors and their frames, with seemingly no rhyme or reason. A nearby ${Quest.CONSORT} explains that at the end of the labyrinth is the ${Quest.DENIZEN}. If the ${Quest.PLAYER1} wants to beat their land, they will have to figure out this Labyrinth.  They are given a ball of yarn so they can easily resume their place in the Labyrinth when they need to take breaks."),
                ...
                new DenizenFightQuest("The final door is passed. The ${Quest.DENIZEN} is revealed.  The choice here is an easy one, it is time to strife!","The bullshit labyrinth is finally complete.","Oh GOD DAMN IT. Now the ${Quest.PLAYER1} has to walk all the way back here to restart the fight.")
