...
class GrimDarkQuests extends Scene{
	...
	String checkSnapOutOfIt(player){
		...
		if(bestFriend != null){
			...
			if(r.value > 10){
				...
				player.changeGrimDark(-3);
				//if you are max grimDark doesn't fully save you...but if you weren't....maybe you get an extra buffer?
				return ret;
			}
		}
		return null;
	...
	String workToCrashSession(player){
			...
			if(player.aspect.isThisMe(Aspects.SPEAR)){
