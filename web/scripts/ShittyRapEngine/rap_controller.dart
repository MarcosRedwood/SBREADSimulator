...
main() {
		...
		var player1 = randomPlayerWithClaspect(session, SBURBClassManager.WITCH, Aspects.KNIFE );
		player1.chatHandle = "squareWave";
		player1.quirk = randomTrollSim(session.rand, player1);
		var player2 = randomPlayerWithClaspect(session, SBURBClassManager.WITCH, Aspects.SPEAR );//why was it so hard to not type 'ace of space'???;
